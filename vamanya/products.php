...
<html lang="en">
    ...
    <body>
        ...
        <h1 class="page-title">Our Jewellery Collection</h1>
        ...
        <div class="products-container">
            ...
            <!-- Product 3 -->
            <div class="product-card">
                <img src="images/Chains/Gold Chain.jpg" alt="Gold Chain">
                <div class="product-info">
                    <div class="product-name">
                        Gold Chain
                    </div>
    ...
    <button type="submit" class="add-cart-btn">
        Add To Cart
            ...
            <!-- Product 5 -->
            <div class="product-card">
                <img src="images/Necklaces/Emerald Leaf Necklace.jpg" alt="Emerald Necklace">
                <div class="product-info">
                    <div class="product-name">
    ...
    <button type="submit" class="add-cart-btn">
        Add To Cart
            ...
            <!-- Product 7 -->
            <div class="product-card">
                <img src="images/Rings/Rose Gold Hammered.jpg" alt="Rings">
                <div class="product-info">
                    <div class="product-name">
    ...
    <button type="submit" class="add-cart-btn">
        Add To Cart
            ...
            <!-- Product 9 -->
            <div class="product-card">
                <img src="images/Bracelets/Rose Gold Bracelet.jpg" alt="Rose Gold Bracelet">
                <div class="product-info">
                    <div class="product-name">
                        Rose Gold Bracelet
                    </div>
    ...
    <button type="submit" class="add-cart-btn">
        Add To Cart
            ...
            <!-- Product 10 -->
            <div class="product-card">
                <img src="images/Necklaces/Platinum Pendants.jpg" alt="Platinum Pendant">
                <div class="product-info">
                    <div class="product-name">
                        Platinum Pendant
                    </div>
