...
<title>Vamanya Jewellery - Chains Collection</title>
...
<section class="collection">
    ...
    <div class="products-container">
        ...
        <div class="product-card">
            <img src="images/Chains/Giva Silver Highness Chain.jpg" alt="Giva Silver Highness Chain">
            <div class="product-info">
                <div class="product-name">Giva Silver Highness Chain</div>
        ...
        <!-- Product 3 -->
        <div class="product-card">
            <img src="images/Chains/Emerald Cut Chain.jpg" alt="Emerald Cut Chain">
            <div class="product-info">
                <div class="product-name">Emerald Cut Chain</div>
        ...
        <div class="product-card">
            ...
            <div class="product-info">
                <div class="product-name">Classic Pearl String</div>
