...
<head>
    ...
    <title>Men's Shorts/Vest Collection | Wearnest</title>
...
<body>
    ...
    <nav>
        ...
        <div class="nav-links">
            ...
            <a href="Mens.php" style="border-bottom: 2px solid var(--accent)">Men</a>
            <a href="#">Women</a>
    ...
    <header class="men-hero">
        ...
        <h1>Men's Shorts/Vest Collection</h1>
    </header>

    <div class="filter-bar">
        <div class="filter-item" onclick="go('Mens.php')">All Items</div>
        <div class="filter-item" onclick="go('T-shirt.php')">T-Shirts</div>
        <div class="filter-item" onclick="go('Shirt.php')">Shirts</div>
        <div class="filter-item" onclick="go('Jeans.php')">Jeans</div>
        <div class="filter-item" onclick="go('Gymwear.php')">Gym Wear</div>
        <div class="filter-item" onclick="go('Traditional.php')">Traditional</div>
        <div class="filter-item active">Shorts / Vest</div>
        <div class="filter-item" onclick="go('Footwear.php')">Footwear</div>
        <div class="filter-item" onclick="go('Watches.php')">Watches</div>
        <div class="filter-item" onclick="go('Fregrance.php')">Fregrance</div>
    </div>
