...
<head>
    ...
    <title>Men's Traditional Collection | Wearnest</title>
...
<body>
    ...
    <header class="men-hero">
        ...
        <h1>Men's Traditional Collection</h1>
    </header>
    ...
    <div class="filter-bar">
        ...
        <div class="filter-item active">Traditional</div>
        <div class="filter-item" onclick="go('Shorts.php')">Shorts / Vest</div>
